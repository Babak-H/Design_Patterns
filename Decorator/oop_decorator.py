...
class ColoredShape(Shape):
    """
    adds a new feature on top of the Circle/Square classes
    """
...
if __name__ == "__main__":
    ...
    # adding two new decorator classes on top of each other
    red_half_transparent_square = TransparentShape(red_circle, 0.5)
    print(red_half_transparent_square)

    # will raise an error to prevent using same decorator twice in a row
